...
class _HomeState extends State<Home> {
            ...
            trailing: Wrap(spacing: 0, children: [
              IconButton(
                ...
                onPressed: () async {
                  ...
                  setState(() {
                    updateName = TextEditingController(text: user.name);
                    updateAge = TextEditingController(text: user.age.toString());
                    updateBirthday = TextEditingController(text: user.birthday.toString());
                  });
                },
              ),
              IconButton(
  ...
  Edit(BuildContext context, Future<dynamic> updateUser(User user), String id) async {
    showDialog(
        context: context,
